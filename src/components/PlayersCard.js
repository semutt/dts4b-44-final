...
const PlayersCard = ({ item }) => {
  return (
    <div className="bg-base-100 rounded-box col-span-3 row-span-3 mx-3 my-3 grid w-72 flex-shrink-0 place-items-center items-center gap-4 p-4 py-8 shadow-xl svelte-1n6ue57">
            ...
            <div className="dropdown w-full">
                <div tabindex="0">
                    <div className="mt-2 text-center">
                        <div className="badge badge-ghost">Flag</div> 
                        <div className="badge badge-ghost">Team</div> 
                        <div className="badge badge-ghost">Position</div>
                    </div>
                </div> 
            </div>
        </div> 
